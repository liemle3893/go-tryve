...
| Type | `notEmpty: true` | `isEmpty: true` |
|------|------------------|-----------------|
| `"John"` | passes | fails |
| `""` | fails | passes |
| `[1,2,3]` | passes | fails |
...
## Empty vs Exists Behavior

| Scenario | `exists: true` | `notEmpty: true` | `isEmpty: true` |
|----------|---------------|------------------|-----------------|
| `[]` (empty array) | passes | fails | passes |
| `[1,2]` (has items) | passes | passes | fails |
| undefined/missing | fails | fails | passes |
